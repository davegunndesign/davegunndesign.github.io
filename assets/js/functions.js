...
/*===============================================
  22. Animated Cursor
===============================================*/
var customCursor = $("#animated-cursor");
...
if (customCursor.length) {
  ...
  var $mouseElm = $("a, button, input, textarea, .accordion-title, .portfolio-filter li");

  $mouseElm.on("mouseenter", function(){
    $("#animated-cursor").addClass("scale-cursor");
  });
  $mouseElm.on("mouseleave", function(){
    $("#animated-cursor").removeClass("scale-cursor");
  });
}
